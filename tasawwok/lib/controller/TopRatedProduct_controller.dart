...
class TopRatedProduct {
  ...
  TopRatedProduct(this.name, this.slug, this.price, this.quantity, this.description, this.rate);


}

class TopRatedProductController extends GetxController {
  RxList<TopRatedProduct> topRatedProducts = <TopRatedProduct>[].obs;
  var TopRatedDataList = [].obs;
      ...
      if (response.statusCode == 200 ||response.statusCode == 201 ) {
       ...
       if (data['message'] == 'succes fetch the top rated products') {
        print("message is correct");
           TopRatedDataList.value = data['data'] as List<dynamic>;
         print("guess here ");
